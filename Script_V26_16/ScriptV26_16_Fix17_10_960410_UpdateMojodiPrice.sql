...
UPDATE  tInventory_Good  
 ...
 Set    BuyAmount = T2.BuyAmount,  
		...
		Mojodi = T2.Mojodi , 
 	    MojodiPrice = CASE tInventory_Good.FirstMojodi + tInventory_Good.BuyAmount  - tInventory_Good.BuyReturnAmount  - tInventory_Good.FromStoreAmount + tInventory_Good.toStoreAmount  WHEN 0 THEN 0 ELSE ( firstMojodiRial + BuyRial - BuyReturnRial - FromStoreRial + toStoreRial ) / (tInventory_Good.FirstMojodi + tInventory_Good.BuyAmount - tInventory_Good.BuyReturnAmount  - tInventory_Good.FromStoreAmount + tInventory_Good.toStoreAmount) END 
