...
Begin VB.Form frmMojodiControl1 
   ClientHeight    =   9360
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15105
   Icon            =   "frmMojodiControl1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VSFlex7LCtl.VSFlexGrid vsGood 
      ...
      FormatString    =   $"frmMojodiControl1.frx":A4C2
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin RESIZEKITLibCtl.ResizeKit ResizeKit1 
      Height          =   480
      Left            =   0
      OleObjectBlob   =   "frmMojodiControl1.frx":A6A6
      TabIndex        =   13
      Top             =   0
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmMojodiControl1"
