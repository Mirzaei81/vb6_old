...
Begin VB.Form frmGroupPer 
   ...
   Begin RESIZEKITLibCtl.ResizeKit ResizeKit1 
      Height          =   480
      Left            =   0
      OleObjectBlob   =   "frmGroupPer.frx":A4C2
      TabIndex        =   4
      Top             =   0
      Width           =   480
   End
...
Private Sub Form_Load()
    ...
    If ClsFormAccess.frmGroupPer = False Then
        Unload Me
        Exit Sub
    End If
...
Private Sub fwBtnRep_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 1
            ...
            If ClsFormAccess.frmPer = True Then
                frmPer.Show
            End If
