VERSION 5.00
Begin VB.Form frmFindGoods_Menu 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "                  ÌÓÊÌæí ßÇáÇåÇí ãäæ Çíä ÇíÓÊÇå             "
   ClientHeight    =   8130
   ClientLeft      =   6045
   ClientTop       =   2430
   ClientWidth     =   10530
   ...
   EndProperty
   Icon            =   "frmFindGoods_Menu.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmFindGoods_Menu"
...
Dim CostOption(0 To 13) As Long
Public Function SendVariables(ByRef index)
    mvarIndex = index
End Function
