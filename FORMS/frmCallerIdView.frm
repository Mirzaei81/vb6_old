...
Begin VB.Form frmCallerIdView 
   ...
   Begin RESIZEKITLibCtl.ResizeKit ResizeKit1 
      Height          =   480
      Left            =   0
      OleObjectBlob   =   "frmCallerIdView.frx":A4C2
      TabIndex        =   3
      Top             =   0
      Width           =   480
   End
   Begin VSFlex7LCtl.VSFlexGrid vsCallerId 
      ...
      FormatString    =   $"frmCallerIdView.frx":A548
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmCallerIdView"
...
Private Sub Form_Load()
    ...
    With vsCallerId
        ...
        .ColAlignment(6) = flexAlignRightCenter
         For i = 0 To .Cols - 1
            .ColWidth(i) = Val(GetSetting(strMainKey, "frmCallerIdView_vsCallerId", "Col" & i))
...
Public Sub Update()
    ...
    Parameter(2) = GenerateInputParameter("@MembershipId", adBigInt, 8, IIf(mvarMemberShipId = 0, Null, mvarMemberShipId))
...
Private Sub vsCallerId_AfterUserResize(ByVal Row As Long, ByVal Col As Long)
    ...
    For i = 0 To vsCallerId.Cols - 1
        SaveSetting strMainKey, "frmCallerIdView_vsCallerId", "Col" & i, vsCallerId.ColWidth(i)
    Next
...
'            frmInvoice.FindCust
            mvarcode = 0
'            If frmInvoice.WindowState = 2 Then frmInvoice.WindowState = 0
'            frmInvoice.Show
