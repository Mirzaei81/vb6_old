...
Begin VB.Form frmMojodiControl_2 
   ClientHeight    =   9255
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15105
   Icon            =   "frmMojodiControl_2.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton StoreDataUpdate 
         Caption         =   "»Â —Ê“ —”«‰Ì „ÊÃÊœÌ ﬂ«·«Â«Ì  Œ—Ìœ‰Ì "
         BeginProperty Font 
            Name            =   "B Homa"
            Size            =   9
            Charset         =   178
   ...
   Begin VSFlex7LCtl.VSFlexGrid vsGood 
      ...
      FormatString    =   $"frmMojodiControl_2.frx":A4C2
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin FLWCtrls.FWLabel FWLabel1 
      ...
      FontSize        =   15.75
      Alignment       =   2
      Picture         =   "frmMojodiControl_2.frx":A5CA
   End
   ...
   Begin RESIZEKITLibCtl.ResizeKit ResizeKit1 
      Height          =   480
      Left            =   5760
      OleObjectBlob   =   "frmMojodiControl_2.frx":A5E6
      TabIndex        =   12
      Top             =   840
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmMojodiControl_2"
...
Public Sub FillvsGood() 'it fills the grid using vw_Good
    ...
    Parameter(2) = GenerateInputParameter("@Type", adInteger, 4, EnumGoodType.forBuy)
        ...
        While Rst.EOF = False
           ...
           ' .TextMatrix(i, 4) = Rst.Fields("TypeDescription").Value
            ...
            Else
                ...
                End If
            End If
            .TextMatrix(i, 10) = Format(Rst.Fields("BuyReturnAmount").Value, "##.000")
            .TextMatrix(i, 11) = Format(Rst.Fields("SaleReturnAmount").Value, "##.000")
            .TextMatrix(i, 12) = Format(Rst.Fields("FromStoreAmount").Value, "##.000")
            .TextMatrix(i, 13) = Format(Rst.Fields("toStoreAmount").Value, "##.000")
            .TextMatrix(i, 14) = IIf(Rst.Fields("MojodiControl").Value = True, -1, 0)
            .TextMatrix(i, 15) = Rst.Fields("OrderPoint").Value
            .TextMatrix(i, 16) = Rst.Fields("MinValue").Value
            .TextMatrix(i, 17) = Rst.Fields("MaxValue").Value
            ...
            Case EnumAddEditMode.EditMode
                ...
                For i = 1 To .Rows - 1
                    ...
                    If InStr(.TextMatrix(i, 0), "*") > 0 Then 'Edited records
                        ...
                        Parameter(1) = GenerateInputParameter("@MojodiControl", adBoolean, 1, IIf(Val(.TextMatrix(i, 14)) = -1, 1, 0))
                        Parameter(2) = GenerateInputParameter("@OrderPoint", adDouble, 8, Val(.TextMatrix(i, 15)))
                        Parameter(3) = GenerateInputParameter("@MinValue", adDouble, 8, Val(.TextMatrix(i, 16)))
                        Parameter(4) = GenerateInputParameter("@MaxValue", adDouble, 8, Val(.TextMatrix(i, 17)))
...
Private Sub cmdInventoryGood_Click()
    Dim intSelectedLevel1 As Integer
...
Private Sub Form_Load()
    ...
    If ClsFormAccess.frmMojodiControl_2 = False Then
        Unload Me
        Exit Sub
    End If
        
    If intVersion = Normal Or intVersion = Min Then
        ShowDisMessage "ﬁ«»·Ì  ﬂ‰ —· ﬂ«·«Â« œ— ‰”ŒÂ Â«Ì ÅÌ‘—› Â Ê »«·« — ÊÃÊœ œ«—œ", 1500
        Unload Me
        Exit Sub
    End If
    ...
    With vsGood
        ...
        Select Case clsStation.Language
            Case Farsi
                ...
                .TextMatrix(0, 10) = "»—ê‘  «“ Œ—Ìœ"
                .TextMatrix(0, 11) = "»—ê‘  «“ ›—Ê‘"
                .TextMatrix(0, 12) = "ÕÊ«·Â «“ «‰»«—"
                .TextMatrix(0, 13) = "—”Ìœ »Â «‰»«—"
                .TextMatrix(0, 14) = " ﬂ‰ —· "
                .TextMatrix(0, 15) = "‰ﬁÿÂ ”›«—‘ "
                .TextMatrix(0, 16) = "Õœ«ﬁ·"
                .TextMatrix(0, 17) = "Õœ«ﬂÀ—"
                .TextMatrix(0, 18) = "    "
            ...
            Case English
                ...
                .TextMatrix(0, 15) = "Ordre"
                .TextMatrix(0, 16) = "Minimum"
                .TextMatrix(0, 17) = "Maximum"
                .TextMatrix(0, 18) = "    "
       End Select
...
''
''            RunParametricStoredProcedure "Update_Calculated_Store", Parameter
''
''            Rst.MoveNext
  ...
  Dim i As Long
    ...
    With vsGood
        If mvarInput = "0" Then
            ...
            Parameter(5) = GenerateInputParameter("@GoodType", adInteger, 4, EnumGoodType.forBuy)
            ...
            CrystalReport1.ReportTitle = "  ê“«—‘ „ÊÃÊœÌ „Ê«œ «Ê·ÌÂ " & cmbInventory.Text
        ...
        ElseIf mvarInput = "1" Then
            ...
            For i = 1 To .Rows - 1
                ...
                Parameter(4) = GenerateInputParameter("@OrderPoint", adDouble, 8, Val(.TextMatrix(i, 15)))
            ...
            CrystalReport1.ReportTitle = "”›«—‘ »—«Ì „Ê«œ «Ê·ÌÂ „’—›Ì "
        Else
            Exit Sub
        End If
...
Exit Sub
Err_Handler:
    LogSaveNew "frmMojodiControl_2 => ", err.Description, err.Number, err.Source, "Printing"
    ShowErrorMessage
End Sub
