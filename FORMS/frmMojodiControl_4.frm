...
Begin VB.Form frmMojodiControl_4 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CheckBox CheckOrder 
         ...
         Caption         =   "ÝÞØ ßÇáÇåÇí ÈÏæä ãæÌæÏí"
         BeginProperty Font 
            Name            =   "B Homa"
            Size            =   9.75
            Charset         =   178
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton StoreDataUpdate 
         Caption         =   "Èå ÑæÒ ÑÓÇäí ãæÌæÏí ßÇáÇåÇí ÝÑæÎÊäí"
         BeginProperty Font 
            Name            =   "B Homa"
            Size            =   9
            Charset         =   178
   ...
   Begin FLWCtrls.FWLabel FWLabel1 
      ...
      _ExtentY        =   873
      Enabled         =   -1  'True
      Caption         =   "ßäÊÑá ßÇáÇ åÇí ÝÑæÎÊäí"
      FirstColor      =   9412754
...
Private Sub Form_Load()
    ...
    If intVersion = Normal Or intVersion = Min Then
        ShowDisMessage "ÞÇÈáíÊ ßäÊÑá ßÇáÇåÇí ÝÑæÎÊäí ÏÑ äÓÎå åÇí íÔÑÝÊå æ ÈÇáÇÊÑ æÌæÏ ÏÇÑÏ", 1500
        Unload Me
        Exit Sub
    End If
    CenterTop Me
    ...
    With vsGood
        ...
        Select Case clsStation.Language
            Case Farsi
                ...
                .TextMatrix(0, 14) = "ÈÑÔÊ ÇÒ ÎÑíÏ"
                .TextMatrix(0, 15) = "ÈÑÔÊ ÇÒ ÝÑæÔ"
                .TextMatrix(0, 16) = "    "
...
With vsGood
  ...
  '  CrystalReport1.ReportFileName = App.Path & "\Reports" & RepVer & "\RepOrder.rpt"
    ...
    CrystalReport1.ReportTitle = "ÓÝÇÑÔ ÈÑÇí ßÇáÇåÇí ÝÑæÎÊäí "
